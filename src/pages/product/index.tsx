  ...
  return (
    <div className={styles.product}>
        ...
        <div className={styles.productDescriptionContainer}>
          <div className={styles.productDescription}>
            <div className={styles.productDescriptionHeader}>
              <h5 className={styles.productDescriptionHeaderText}>
                About Product
              </h5>
            </div>
            <div className={styles.productDescriptionText}>
              <p className={styles.productDescriptionTextCaption}>
                {currentElement?.name} <span></span> {currentElement?.size}mm
              </p>
              <div className={styles.productDescriptionTextPrice}>
                <h4 className={styles.productDescriptionTextHeading}>
                  {currentElement?.category} {currentElement?.name}
                </h4>
                <p className={styles.productDescriptionTextPriceContent}>
              ...
              <div className={styles.productDescriptionTextSizeContainer}>
                <div className={styles.productDescriptionTextSize}>
                  ...
                  {currentElement?.sizeRange?.map(
                    (element: any, index: number) => {
                      return (
                        <Badge
                          key={index + 1}
                          active={Boolean(currentElement?.size === element)}
                          label={`${element}`}
                        />
                      );
                    }
      ...
      <div className={styles.productLikeItems}>
        <h4 className={styles.productLikeItemsHeading}>
